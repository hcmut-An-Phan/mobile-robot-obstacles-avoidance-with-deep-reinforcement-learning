...
"""
    Priotized Replay Buffer - Ranked based priority
"""
...
class RankBasePER:
    def __init__(self, conf):
        ...
        self.batch_size = conf['batch_size'] if 'batch_size' in conf else 512
        self.learn_start = conf['learn_start'] if 'learn_start' in conf else 0 
    ...
    def build_distributions(self):
        ...
        print("n partition: ", n_partitions)
        ...
        for n in range(partition_size, self.size + 1, partition_size):
            if self.learn_start <= n <= self.priority_size:
                ...
                # split to k segment, and then uniform sample in each k
...
if __name__ == "__main__":
    ...
    print(experience.priority_queue.p2e)
    ...
    # experience.update_priority([1, 2, 3], [80, 90, 100])
    # print(experience.priority_queue.p2e)
