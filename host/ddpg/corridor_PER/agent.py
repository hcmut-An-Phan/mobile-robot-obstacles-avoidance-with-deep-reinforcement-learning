...
class AgentDDPG:
	...
	def load_human_data(self):
		"""
		load demonstrate human's action and save to buffer
		"""
		mat_contents = sio.loadmat('hanh_lang_data.mat')
	...
	def get_Q_value(self, state, action):
		"""
		Predict Q-value(state, action) by critic network
	...
	def learn(self, global_step):
		...
		# recompute TD-error and update priority
